...
namespace DirectX{
	...
	public:
		...
		DepthStencilBuffer(ID3D11Device* pDevice, unsigned int Width, unsigned int Height, _In_opt_ DXGI_FORMAT Format = DXGI_FORMAT_D24_UNORM_S8_UINT, UINT MuiltiSampleCount = 1, UINT MuiltiSampleQuality = 0);
		~DepthStencilBuffer();
